...
slim_setup()
{
cat > "${release}/usr/local/etc/slim.conf" <<EOF
input_font	Helvetica:size=11.5
welcome_font	Helvetica:size=11.5
intro_font	Helvetica:size=11.5
username_font	Helvetica:size=11.5
msg_font	Helvetica:size=16:bold
session_font	Helvetica:size=16:bold
...
screenshot_cmd      /usr/local/bin/screenshot
